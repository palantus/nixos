  ...
  wayland.windowManager.hyprland.settings = {
    ...
    binde =
      ...
      [
        ...
        "Control_L&Shift_L&Alt_L, h, resizeactive, -20 0"
        "Control_L&Shift_L&Alt_L, j, resizeactive, 0 20"
        "Control_L&Shift_L&Alt_L, k, resizeactive, 0 -20"
        "Control_L&Shift_L&Alt_L, l, resizeactive, 20 0"
